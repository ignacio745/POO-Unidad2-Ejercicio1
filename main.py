...
unMenu = Menu(["Elija una opcion", "Crear cuenta de email", "Modificar contraseña de la cuenta", "Crear cuenta a partir de direccion", "Leer csv", "Mostrar emails del csv", "TEST", "Salir"])
...
def test():
    unEmail = Email("ignacio.benemerito", "gmail", "com", "2341")
    print(unEmail)
